/**
 * @file   geometry_lar1nd_test.cxx
 * @brief  Unit test for geometry on SBND detector
 * @date   May 11th, 2015
 * @author petrillo@fnal.gov
 * 
 * Usage:
 *   `geometry_lar1nd_test  [ConfigurationFile [GeometryTestParameterSet]]`
 * 
...
int main(int argc, char const** argv) {
  ...
  LAr1NDGeometryConfiguration config("geometry_test_LAr1ND");
  ...
  if (nErrors > 0) {
    mf::LogError("geometry_test_LAr1ND") << nErrors << " errors detected!";
  }
