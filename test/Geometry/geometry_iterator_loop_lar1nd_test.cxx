/**
 * @file   geometry_iterator_loop_lar1nd_test.cxx
 * @brief  Test for geometry iterator loops on SBND detector
 * @date   May 11th, 2015
 * @author petrillo@fnal.gov
 * 
 * Usage:
 *   `geometry_iterator_loop_lar1nd_test [ConfigurationFile [GeometryTestParameterSet]]`
 * 
 * By default, an internal configuration is used or GeometryTestParameterSet is
 * set to "physics.analyzers.geotest".
 * 
 */
...
using LAr1NDGeometryConfiguration
 ...
 */
using LAr1NDGeometryTestEnvironment
  = testing::GeometryTesterEnvironment<LAr1NDGeometryConfiguration>;
...
int main(int argc, char const** argv) {
  ...
  LAr1NDGeometryConfiguration config
    ("geometry_iterator_loop_test_LAr1ND");
  ...
  // (optional; default: "physics.analyzers.geotest");
  ...
  //
  LAr1NDGeometryTestEnvironment TestEnvironment(config);
  ...
  if (nErrors > 0) {
    mf::LogError("geometry_iterator_loop_test_LAr1ND")
