  ...
  for(auto&& [ signal_i, signal ] : enumerate(signals))
    {
      ...
      NormaliseEntriesByBinWidthX(nominalHists[signal_i], plotSet.scale1);
          ...
          for(int univ_i = 0; univ_i < n_univs; ++univ_i)
            {
              ...
              NormaliseEntriesByBinWidthX(univHists[signal_i][weight_i][univ_i], plotSet.scale1);
            }
        }
    }
          ...
          for(int frame_i = 0; frame_i < plotSet.nbins2; ++frame_i)
            {
              ...
              nominalHist->SetTitle(Form("%.2f < %s < %.2f;%s;Events / %s", plotSet.bins2[frame_i], plotSet.axis2.Data(), plotSet.bins2[frame_i+1], plotSet.axis1.Data(), plotSet.normalisationUnit1.Data()));
              ...
              for(int univ_i = 0; univ_i < n_univs; ++univ_i)
                {
                  ...
                  univHist->SetTitle(Form("%.2f < %s < %.2f;%s;Events / %s", plotSet.bins2[frame_i], plotSet.axis2.Data(), plotSet.bins2[frame_i+1], plotSet.axis1.Data(), plotSet.normalisationUnit1.Data()));
