...
std::vector<Plot> thesis_corr_plots = {
  { "slc_n_razzled_photons", "slc_n_razzled_photons", ";N Razzled Photons;Candidates",
    5, -0.5, 4.5 },
  { "slc_n_razzled_photons_log", "slc_n_razzled_photons", ";N Razzled Photons;Candidates",
    5, -0.5, 4.5, kBlack, true },
};
...
std::vector<Plot> selection_plots = {
  ...
  { "slc_is_fv", "slc_is_fv", ";Is FV?;Candidates",
    2, -0.5, 1.5, kBlack, false, "", true, {"No", "Yes"} },
  ...
  { "slc_n_razzled_photons_log", "slc_n_razzled_photons", ";N Razzled Photons;Candidates",
    5, -0.5, 4.5, kBlack, true },
  { "slc_best_corr_pzc_good_kinematics", "slc_best_corr_pzc_good_kinematics", ";Best #pi^{0} Candidates Good Kinematics?;Candidates",
    2, -0.5, 1.5, kBlack, false, "", true, {"No", "Yes"} },
  { "slc_opt0_fracPE", "slc_opt0_fracPE", ";(L_{Q} - L) / L;Candidates",
    100, -2, 8 },
  { "slc_opt0_fracPE_log", "slc_opt0_fracPE", ";(L_{Q} - L) / L;Candidates",
    100, -2, 8, kBlack, true },
...
std::vector<Plot> optimisation_plots = {
  ...
  { "slc_crumbs_nc_score", "slc_crumbs_nc_score", ";  CRUMBS NC Score;Candidates",
    50, -1.5, 1. },
  //  { "slc_opt0_fracPE", "slc_opt0_fracPE", ";#frac{L_Q - L}{L};Candidates",
...
std::vector<Plot> extension_plots = {
  { "slc_opt0_fracPE", "slc_opt0_fracPE", ";#frac{L_Q - L}{L};Candidates",
    100, -2, 8 },
  { "slc_opt0_fracPE_log", "slc_opt0_fracPE", ";#frac{L_Q - L}{L};Candidates",
    100, -2, 8, kBlack, true },
  { "slc_opt0_fracPE_log_narrow", "slc_opt0_fracPE", ";#frac{L_Q - L}{L};Candidates",
    100, -2, 2, kBlack, true },
  { "slc_opt0_score", "slc_opt0_score", ";OpT0 Score;Candidates",
    100, 0, 2e5 },
...
std::vector<VarBinPlot> observables_corr = {
  ...
  { "slc_best_corr_pzc_pizero_mom_corr", "slc_best_corr_pzc_pizero_mom_corr", ";p_{#pi^{0}} (MeV/c);Candidates / 60 MeV/c",
    pizeromombins.size() - 1, pizeromombins, 60. },
  //12, { 0., 60., 100, 140., 180., 220., 260., 300., 350., 400., 500., 600., 1000. }, 60. },
