...
std::vector<Plot> selection_plots = {
  ...
  { "slc_is_fv", "slc_is_fv", ";IsFV?;Slices",
    2, -0.5, 1.5, kBlack, false, "", true, {"No", "Yes"} },
  ...
  { "slc_n_razzled_photons", "slc_n_razzled_photons", ";N Razzled Photons;Slices",
    5, -0.5, 4.5 },
  { "slc_best_corr_pzc_good_kinematics", "slc_best_corr_pzc_good_kinematics", ";Best #pi^{0} Slices Good Kinematics?;Slices",
    2, -0.5, 1.5, kBlack, false, "", true, {"No", "Yes"} },
  { "slc_opt0_fracPE", "slc_opt0_fracPE", ";OpT0 Fractional PE Difference;Slices",
    100, -2, 8 },
  { "slc_opt0_fracPE_log", "slc_opt0_fracPE", ";OpT0 Fractional PE Difference;Slices",
    100, -2, 8, kBlack, true },
...
std::vector<Plot> extension_plots = {
  ...
  { "slc_opt0_fracPE_log", "slc_opt0_fracPE", ";OpT0 Fractional PE Difference;Slices",
    100, -2, 8, kBlack, true },
  { "slc_opt0_fracPE_log_narrow", "slc_opt0_fracPE", ";OpT0 Fractional PE Difference;Slices",
    100, -2, 2, kBlack, true },
  { "slc_opt0_score", "slc_opt0_score", ";OpT0 Score;Slices",
    100, 0, 2e5 },
...
std::vector<VarBinPlot> true_slc_observables = {
  { "slc_true_pz_pizero_mom", "slc_true_pz_pizero_mom*1e3", ";True p_{#pi^{0}} (MeV/c);Slices / 60 MeV/c",
    pizeromombins.size() - 1, pizeromombins, 60. },
  { "slc_true_pz_cos_theta_pizero", "slc_true_pz_cos_theta_pizero", ";True cos(#theta_{#pi^{0}});Slices / 0.1",
    costhetapizerobins.size() - 1, costhetapizerobins, 0.1 },
  { "slc_true_pz_cos_com", "slc_true_pz_cos_com", ";True cos(#theta_{CoM});Slices / 0.1",
    coscombins.size() - 1, coscombins, 0.1 },
  { "slc_true_pz_decay_asymmetry", "slc_true_pz_decay_asymmetry", ";True |E_{#gamma_{1}} - E_{#gamma_{2}}| / E_{#gamma_{1}} + E_{#gamma_{2}};Slices / 0.1",
    decayasymbins.size() - 1, decayasymbins, 0.1 },
  { "slc_true_pz_open_angle", "slc_true_pz_open_angle", ";True #theta_{#gamma#gamma} (#circ);Slices / 20#circ",
    openanglebins.size() - 1, openanglebins, 20. },
};
