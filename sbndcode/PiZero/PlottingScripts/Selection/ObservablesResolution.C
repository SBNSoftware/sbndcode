void ObservablesResolution(const TString productionVersion)
{
  ...
  ncpizeroEvents->Draw("(slc_best_pzc_pizero_mom-slc_true_pz_pizero_mom*1e3)/(slc_true_pz_pizero_mom*1e3)>>hPiZeroMomResolution",
  ...
  ncpizeroEvents->Draw("(slc_best_pzc_cos_theta_pizero-slc_true_pz_cos_theta_pizero)/slc_true_pz_cos_theta_pizero>>hCosineThetaPiZeroResolution",
                       "slc_sel_incl && slc_true_event_type_incl==0 && slc_comp>.5");
  ...
  ncpizeroEvents->Draw("(slc_pfp_shower_energy-slc_pfp_true_energy)/(slc_pfp_true_energy)>>hShowerEnergyResolution",
                       "slc_pfp_pdg==11 && slc_pfp_comp>.5 && slc_pfp_pur>.5 && slc_pfp_shower_contained");
