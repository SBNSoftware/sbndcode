...
void HitAnalysisAlg::setup(const geo::GeometryCore&           geometry,
                           const geo::WireReadoutGeom&        readout,
...
//    art::TFileDirectory dir = tfs->mkdir(fLocalDirName.c_str());
    ...
    fHitsByWire[0]            = std::make_unique<TH1D>("HitsByWire0", ";Wire #", fReadout->Nwires(geo::PlaneID(0, 0, 0)), 0., fReadout->Nwires(geo::PlaneID(0, 0, 0)));
    fHitsByWire[1]            = std::make_unique<TH1D>("HitsByWire1", ";Wire #", fReadout->Nwires(geo::PlaneID(0, 0, 1)), 0., fReadout->Nwires(geo::PlaneID(0, 0, 1)));
    fHitsByWire[2]            = std::make_unique<TH1D>("HitsByWire2", ";Wire #", fReadout->Nwires(geo::PlaneID(0, 0, 2)), 0., fReadout->Nwires(geo::PlaneID(0, 0, 2)));
    ...
    fBadWHitsByWire           = std::make_unique<TH1D>("BWHitsByWire",  ";Wire #", fReadout->Nwires(geo::PlaneID(0, 0, 2)), 0., fReadout->Nwires(geo::PlaneID(0, 0, 2)));
