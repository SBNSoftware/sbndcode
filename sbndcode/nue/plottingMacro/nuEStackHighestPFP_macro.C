...
void styleDraw(histGroup hist, const char* filename){
    ...
    TLegend* legend = new TLegend(0.76, 0.8, 0.9, 0.9);
    legend->SetHeader("Highest Energy PFP", "C");
...
void nuEStackHighestPFP_macro(){
    TFile *file = TFile::Open("/exp/sbnd/data/users/coackley/merged_23July.root");
    //std::string base_path = "/nashome/c/coackley/nuEPlotsHighestPFPStackSignal/Signal_Uboone_";
    //std::string base_path = "/nashome/c/coackley/nuEPlotsHighestPFPStackSignal/BNB_Uboone_";
    //std::string base_path = "/nashome/c/coackley/nuEPlotsHighestPFPStackSignal/IntimeCosmic_Uboone_";
    //std::string base_path = "/nashome/c/coackley/nuEPlotsHighestPFPStackSignal/Signal_Current_";
    //std::string base_path = "/nashome/c/coackley/nuEPlotsHighestPFPStackSignal/BNB_Current_";
    std::string base_path = "/nashome/c/coackley/nuEPlotsHighestPFPStackSignal/IntimeCosmic_Current_";
    ...
    for(Long64_t i = 0; i < numEntries; ++i){
        ...
        if(chosenRecoParticleCRUMBS.truePDG == 11){
        ...
        } else if(chosenRecoParticleCRUMBS.truePDG == -11){
        ...
        } else if(chosenRecoParticleCRUMBS.truePDG == 13){
        ...
        } else if(chosenRecoParticleCRUMBS.truePDG == 211){
        ...
        } else if(chosenRecoParticleCRUMBS.truePDG == 22){
        ...
        } else if(chosenRecoParticleCRUMBS.truePDG == 2212){
