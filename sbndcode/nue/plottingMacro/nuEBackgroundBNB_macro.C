...
void nuEBackgroundBNB_macro(){
    //TFile *file = TFile::Open("/exp/sbnd/app/users/coackley/nuev10_06_00/srcs/sbndcode/sbndcode/nue/NuEAnalyserOutput.root");
    TFile *file = TFile::Open("/exp/sbnd/data/users/coackley/BNBEvents/merged.root");


    std::string base_path = "/nashome/c/coackley/nuEBackgroundPlotsBNB/";
