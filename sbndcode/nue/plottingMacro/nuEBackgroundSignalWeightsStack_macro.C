...
void nuEBackgroundSignalWeightsStack_macro(){
    ...
    */
    ...
    weighted(allRecoVertexX.currentSignal, allRecoVertexX.ubooneSignal, allRecoVertexX.currentBNB, allRecoVertexX.ubooneBNB, allRecoVertexX.currentCosmics, allRecoVertexX.ubooneCosmics, signalWeight, BNBWeight, cosmicsWeight, 999, 999, 999, 999, (base_path + "allRecoVertexX_weighted.pdf").c_str(), "topRight");
    ...
    weighted(allRecoVertexY.currentSignal, allRecoVertexY.ubooneSignal, allRecoVertexY.currentBNB, allRecoVertexY.ubooneBNB, allRecoVertexY.currentCosmics, allRecoVertexY.ubooneCosmics, signalWeight, BNBWeight, cosmicsWeight, 999, 999, 999, 999, (base_path + "allRecoVertexY_weighted.pdf").c_str(), "topRight");
    ...
    weighted(allRecoVertexZ.currentSignal, allRecoVertexZ.ubooneSignal, allRecoVertexZ.currentBNB, allRecoVertexZ.ubooneBNB, allRecoVertexZ.currentCosmics, allRecoVertexZ.ubooneCosmics, signalWeight, BNBWeight, cosmicsWeight, 999, 999, 999, 999, (base_path + "allRecoVertexZ_weighted.pdf").c_str(), "topRight");
