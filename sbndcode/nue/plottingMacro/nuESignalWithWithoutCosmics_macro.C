...
void ProfileDrawDouble(TProfile* profile1, TProfile* profile2, const char* filename, const char* title, const std::string& legendLocation){
    ...
    profile1->SetMarkerColor(kBlack);
    profile1->SetLineColor(kBlack);
    profile1->Draw();
    profile1->GetXaxis()->SetTickLength(0.04);
    profile1->GetYaxis()->SetTickLength(0.03);
    profile1->GetXaxis()->SetTickSize(0.02);
    profile1->GetYaxis()->SetTickSize(0.02);
    
    profile2->SetLineColor(kBlue);
    profile2->SetMarkerColor(kBlue);
    profile2->SetMarkerStyle(21);
...
void styleDraw(TCanvas* canvas, TH1F* current, TH1F* cheated, TH1F* dune, TH1F* uboone, TH1F* sbnd, TH1F* nue, TH1F* nue_100k, double ymin, double ymax, double xmin, double xmax, const std::string& legendLocation, const char* filename, TPaveText* pt = nullptr, int* percentage = nullptr, int* drawLine = nullptr, int* linePos = nullptr){
    ...
    legend->AddEntry(uboone, "Nu+E Elastic Scattering, Without Cosmics", "f");
    //legend->AddEntry(sbnd, "Pandora Deep Learning: SBND/BNB Tune", "f");
    //legend->AddEntry(current, "Pandora BDT SBND (without Refinement)", "f");
    legend->AddEntry(current, "Nu+E Elastic Scattering, With Cosmics", "f");
...
void percentage(TH1F* current, TH1F* cheated, TH1F* dune, TH1F* uboone, TH1F* sbnd, TH1F* nue, TH1F* nue_100k, double sizeCurrent, double sizeCheated, double sizeDune, double sizeUboone, double sizeSBND, double sizeNuE, double sizeNuE_100k, double ymin, double ymax, double xmin, double xmax, const std::string& legendLocation, const char* filename, int* drawLine = nullptr, int* linePos = nullptr){
    ...
    //cheatedPerc->Scale(1.0 / cheatedPerc->Integral());
    ...
    //dunePerc->Scale(1.0 / dunePerc->Integral());
    ...
    //sbndPerc->Scale(1.0 / sbndPerc->Integral());
    ...
    //nuePerc->Scale(1.0 / nuePerc->Integral());
...
void nuESignalWithWithoutCosmics_macro(){
    ...
    TProfile *numPFPsAngleDifferenceWithCosmicsCRUMBSProfile = new TProfile("numPFPsAngleDifferenceWithCosmicsCRUMBSProfile", "", 7, 0, 7, 0, 180); 
    TProfile *numPFPsERecoSumThetaRecoWithCosmicsCRUMBSProfile = new TProfile("numPFPsERecoSumThetaRecoWithCosmicsCRUMBSProfile", "", 7, 0, 7, 0, 14); 
    TProfile *numPFPsERecoHighestThetaRecoWithCosmicsCRUMBSProfile = new TProfile("numPFPsERecoHighestThetaRecoWithCosmicsCRUMBSProfile", "", 7, 0, 7, 0, 14); 
    
    TProfile *numPFPsAngleDifferenceWithoutCosmicsCRUMBSProfile = new TProfile("numPFPsAngleDifferenceWithoutCosmicsCRUMBSProfile", "", 7, 0, 7, 0, 180); 
    TProfile *numPFPsERecoSumThetaRecoWithoutCosmicsCRUMBSProfile = new TProfile("numPFPsERecoSumThetaRecoWithoutCosmicsCRUMBSProfile", "", 7, 0, 7, 0, 14); 
    TProfile *numPFPsERecoHighestThetaRecoWithoutCosmicsCRUMBSProfile = new TProfile("numPFPsERecoHighestThetaRecoWithoutCosmicsCRUMBSProfile", "", 7, 0, 7, 0, 14); 
