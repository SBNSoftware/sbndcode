...
void nuEBackgroundSignalWeightsStack_macro(){
    ...
    for(Long64_t i = 0; i < numEntriesSubRun; ++i){
        ...
        if(subRunSignal == 1){
            if(subRunDLCurrent == 2) std::pair<unsigned int, unsigned int> keySignalCurrent = std::make_pair(subRunRun, subRunNumber);
            if(subRunDLCurrent == 0) std::pair<unsigned int, unsigned int> keySignalUboone = std::make_pair(subRunRun, subRunNumber);
            if(subRunDLCurrent == 5) std::pair<unsigned int, unsigned int> keySignalNue = std::make_pair(subRunRun, subRunNumber);
            
            if(subRunDLCurrent == 2 && seenSubRunsSignalCurrent.find(keySignalCurrent) == seenSubRunsSignalCurrent.end()){
                totalPOTSignalCurrent += subRunPOT;
                seenSubRunsSignalCurrent.insert(keySignalCurrent);
            } else if(subRunDLCurrent == 0 && seenSubRunsSignalUboone.find(keySignalUboone) == seenSubRunsSignalUboone.end()){
                totalPOTSignalUboone += subRunPOT;
                seenSubRunsSignalUboone.insert(keySignalUboone);
            } else if(subRunDLCurrent == 5 && seenSubRunsSignalNue.find(keySignalNue) == seenSubRunsSignalNue.end()){
                totalPOTSignalNue += subRunPOT;
                seenSubRunsSignalNue.insert(keySignalNue);
            }
        } else if(subRunSignal == 2){
            if(subRunDLCurrent == 2) std::pair<unsigned int, unsigned int> keyBNBCurrent = std::make_pair(subRunRun, subRunNumber);
            if(subRunDLCurrent == 0) std::pair<unsigned int, unsigned int> keyBNBUboone = std::make_pair(subRunRun, subRunNumber);
            if(subRunDLCurrent == 5) std::pair<unsigned int, unsigned int> keyBNBNue = std::make_pair(subRunRun, subRunNumber);
            
            if(subRunDLCurrent == 2 && seenSubRunsBNBCurrent.find(keyBNBCurrent) == seenSubRunsBNBCurrent.end()){
                totalPOTBNBCurrent += subRunPOT;
                seenSubRunsBNBCurrent.insert(keyBNBCurrent);
            } else if(subRunDLCurrent == 2){
                totalPOTBNBCurrent += subRunPOT;
            } else if(subRunDLCurrent == 0 && seenSubRunsBNBUboone.find(keyBNBUboone) == seenSubRunsBNBUboone.end()){
                totalPOTBNBUboone += subRunPOT;
                seenSubRunsBNBUboone.insert(keyBNBUboone);
            } else if(subRunDLCurrent == 0){
                totalPOTBNB += subRunPOT;
            } else if(subRunDLCurrent == 5 && seenSubRunsBNB.find(keyBNBNue) == seenSubRunsBNBNue.end()){
                totalPOTBNBNue += subRunPOT;
                seenSubRunsBNBNue.insert(keyBNBNue);
            } else if(subRunDLCurrent == 5){
                totalPOTBNBNue += subRunPOT;
            }
        } else if(subRunSignal == 3 && subRunDLCurrent == 2){
            std::pair<unsigned int, unsigned int> keyCosmicsCurrent = std::make_pair(subRunRun, subRunNumber);
            if(subRunDLCurrent == 0 && seenSubRunsCosmicsCurrent.find(keyCosmicsCurrent) == seenSubRunsCosmicsCurrent.end()){
                totalPOTCosmicsCurrent += subRunPOT;
                seenSubRunsCosmicsCurrent.insert(keyCosmicsCurrent);
            }
        } else if(subRunSignal == 3 && subRunDLCurrent == 0){
            std::pair<unsigned int, unsigned int> keyCosmicsUboone = std::make_pair(subRunRun, subRunNumber);
            if(subRunDLCurrentUboone == 0 && seenSubRunsCosmicsUboone.find(keyCosmicsUboone) == seenSubRunsCosmicsUboone.end()){
                totalPOTCosmicsUboone += subRunPOT;
                seenSubRunsCosmicsUboone.insert(keyCosmicsUboone);
            }
        } else if(subRunSignal == 3 && subRunDLCurrent == 5){
            std::pair<unsigned int, unsigned int> keyCosmicsNue = std::make_pair(subRunRun, subRunNumber);
            if(subRunDLCurrent == 0 && seenSubRunsCosmicsNue.find(keyCosmicsNue) == seenSubRunsCosmicsNue.end()){
                totalPOTCosmicsNue += subRunPOT;
                seenSubRunsCosmicsNue.insert(keyCosmicsNue);
            }
        } 
    }
    ...
    weighted(numRecoNeutrinos.currentSignal, numRecoNeutrinos.ubooneSignal, numRecoNeutrinos.currentBNB, numRecoNeutrinos.ubooneBNB, numRecoNeutrinos.currentCosmics, numRecoNeutrinos.ubooneCosmics, signalWeightCurrent, BNBWeightCurrent, cosmicsWeightCurrent, signalWeightUboone, BNBWeightUboone, cosmicsWeightUboone, signalWeightNue, BNBWeightNue, cosmicsWeightNue, 999, 999, 999, 999, (base_path + "numRecoNeutrinos_weighted.pdf").c_str(), "topRight");
    ...
    */
    ...
    weighted(primaryVertexYCRUMBSPositive.currentSignal, primaryVertexYCRUMBSPositive.ubooneSignal, primaryVertexYCRUMBSPositive.currentBNB, primaryVertexYCRUMBSPositive.ubooneBNB, primaryVertexYCRUMBSPositive.currentCosmics, primaryVertexYCRUMBSPositive.ubooneCosmics, signalWeightCurrent, BNBWeightCurrent, cosmicsWeightCurrent, signalWeightUboone, BNBWeightUboone, cosmicsWeightUboone, signalWeightNue, BNBWeightNue, cosmicsWeightNue, 999, 999, 180, 203.8, (base_path + "primaryVertexY_weighted_positive.pdf").c_str(), "bottomLeft");
    ...
    weighted(ERecoHighestThetaRecoCRUMBS.currentSignal, ERecoHighestThetaRecoCRUMBS.ubooneSignal, ERecoHighestThetaRecoCRUMBS.currentBNB, ERecoHighestThetaRecoCRUMBS.ubooneBNB, ERecoHighestThetaRecoCRUMBS.currentCosmics, ERecoHighestThetaRecoCRUMBS.ubooneCosmics, signalWeightCurrent, BNBWeightCurrent, cosmicsWeightCurrent, signalWeightUboone, BNBWeightUboone, cosmicsWeightUboone, signalWeightNue, BNBWeightNue, cosmicsWeightNue, 999, 999, 999, 999, (base_path + "ERecoHighestThetaRecoCRUMBS_weighted.pdf").c_str(), "topRight", &drawLine, &right);
    ...
    styleDraw(allRecoVertexX.canvas, allRecoVertexX.currentSignal, allRecoVertexX.ubooneSignal, allRecoVertexX.currentBNB, allRecoVertexX.ubooneBNB, allRecoVertexX.currentCosmics, allRecoVertexX.ubooneCosmics, 999, 999, 999, 999, (base_path + "allRecoVertexX_dist.pdf").c_str(), "topRight");
    weighted(allRecoVertexX.currentSignal, allRecoVertexX.ubooneSignal, allRecoVertexX.currentBNB, allRecoVertexX.ubooneBNB, allRecoVertexX.currentCosmics, allRecoVertexX.ubooneCosmics, signalWeightCurrent, BNBWeightCurrent, cosmicsWeightCurrent, signalWeightUboone, BNBWeightUboone, cosmicsWeightUboone, signalWeightNue, BNBWeightNue, cosmicsWeightNue, 999, 999, 999, 999, (base_path + "allRecoVertexX_weighted.pdf").c_str(), "topRight");
    efficiency(allRecoVertexX.currentSignal, allRecoVertexX.ubooneSignal, allRecoVertexX.currentBNB, allRecoVertexX.ubooneBNB, allRecoVertexX.currentCosmics, allRecoVertexX.ubooneCosmics, numEventsCRUMBSRecoParticle.currentSignal, numEventsCRUMBSRecoParticle.ubooneSignal, numEventsCRUMBSRecoParticle.currentBNB, numEventsCRUMBSRecoParticle.ubooneBNB, numEventsCRUMBSRecoParticle.currentCosmics, numEventsCRUMBSRecoParticle.ubooneCosmics, 0, 1, 999, 999, (base_path + "allRecoVertexX_eff.pdf").c_str(), (base_path + "allRecoVertexX_rej.pdf").c_str(), (base_path + "allRecoVertexX_effrejpur.pdf").c_str(), (base_path + "allRecoVertexX_pur.pdf").c_str(), (base_path + "allRecoVertexX_effpur.pdf").c_str(), "bottomRight", signalWeightCurrent, BNBWeightCurrent, cosmicsWeightCurrent, signalWeightUboone, BNBWeightUboone, cosmicsWeightUboone, signalWeightNue, BNBWeightNue, cosmicsWeightNue, &drawLine, &right, "E_{reco}#theta_{reco}^{2} (MeV rad^{2})", 1, &currentMaxEffPur, &ubooneMaxEffPur);
    
    styleDraw(allRecoVertexY.canvas, allRecoVertexY.currentSignal, allRecoVertexY.ubooneSignal, allRecoVertexY.currentBNB, allRecoVertexY.ubooneBNB, allRecoVertexY.currentCosmics, allRecoVertexY.ubooneCosmics, 999, 999, 999, 999, (base_path + "allRecoVertexY_dist.pdf").c_str(), "topRight");
    weighted(allRecoVertexY.currentSignal, allRecoVertexY.ubooneSignal, allRecoVertexY.currentBNB, allRecoVertexY.ubooneBNB, allRecoVertexY.currentCosmics, allRecoVertexY.ubooneCosmics, signalWeightCurrent, BNBWeightCurrent, cosmicsWeightCurrent, signalWeightUboone, BNBWeightUboone, cosmicsWeightUboone, signalWeightNue, BNBWeightNue, cosmicsWeightNue, 999, 999, 999, 999, (base_path + "allRecoVertexY_weighted.pdf").c_str(), "topRight");
    efficiency(allRecoVertexY.currentSignal, allRecoVertexY.ubooneSignal, allRecoVertexY.currentBNB, allRecoVertexY.ubooneBNB, allRecoVertexY.currentCosmics, allRecoVertexY.ubooneCosmics, numEventsCRUMBSRecoParticle.currentSignal, numEventsCRUMBSRecoParticle.ubooneSignal, numEventsCRUMBSRecoParticle.currentBNB, numEventsCRUMBSRecoParticle.ubooneBNB, numEventsCRUMBSRecoParticle.currentCosmics, numEventsCRUMBSRecoParticle.ubooneCosmics, 0, 1, 999, 999, (base_path + "allRecoVertexY_eff.pdf").c_str(), (base_path + "allRecoVertexY_rej.pdf").c_str(), (base_path + "allRecoVertexY_effrejpur.pdf").c_str(), (base_path + "allRecoVertexY_pur.pdf").c_str(), (base_path + "allRecoVertexY_effpur.pdf").c_str(), "bottomRight", signalWeightCurrent, BNBWeightCurrent, cosmicsWeightCurrent, signalWeightUboone, BNBWeightUboone, cosmicsWeightUboone, signalWeightNue, BNBWeightNue, cosmicsWeightNue, &drawLine, &right, "E_{reco}#theta_{reco}^{2} (MeV rad^{2})", 1, &currentMaxEffPur, &ubooneMaxEffPur);
    
    styleDraw(allRecoVertexZ.canvas, allRecoVertexZ.currentSignal, allRecoVertexZ.ubooneSignal, allRecoVertexZ.currentBNB, allRecoVertexZ.ubooneBNB, allRecoVertexZ.currentCosmics, allRecoVertexZ.ubooneCosmics, 999, 999, 999, 999, (base_path + "allRecoVertexZ_dist.pdf").c_str(), "topRight");
    weighted(allRecoVertexZ.currentSignal, allRecoVertexZ.ubooneSignal, allRecoVertexZ.currentBNB, allRecoVertexZ.ubooneBNB, allRecoVertexZ.currentCosmics, allRecoVertexZ.ubooneCosmics, signalWeightCurrent, BNBWeightCurrent, cosmicsWeightCurrent, signalWeightUboone, BNBWeightUboone, cosmicsWeightUboone, signalWeightNue, BNBWeightNue, cosmicsWeightNue, 999, 999, 999, 999, (base_path + "allRecoVertexZ_weighted.pdf").c_str(), "topRight");
    efficiency(allRecoVertexZ.currentSignal, allRecoVertexZ.ubooneSignal, allRecoVertexZ.currentBNB, allRecoVertexZ.ubooneBNB, allRecoVertexZ.currentCosmics, allRecoVertexZ.ubooneCosmics, numEventsCRUMBSRecoParticle.currentSignal, numEventsCRUMBSRecoParticle.ubooneSignal, numEventsCRUMBSRecoParticle.currentBNB, numEventsCRUMBSRecoParticle.ubooneBNB, numEventsCRUMBSRecoParticle.currentCosmics, numEventsCRUMBSRecoParticle.ubooneCosmics, 0, 1, 999, 999, (base_path + "allRecoVertexZ_eff.pdf").c_str(), (base_path + "allRecoVertexZ_rej.pdf").c_str(), (base_path + "allRecoVertexZ_effrejpur.pdf").c_str(), (base_path + "allRecoVertexZ_pur.pdf").c_str(), (base_path + "allRecoVertexZ_effpur.pdf").c_str(), "bottomRight", signalWeightCurrent, BNBWeightCurrent, cosmicsWeightCurrent, signalWeightUboone, BNBWeightUboone, cosmicsWeightUboone, signalWeightNue, BNBWeightNue, cosmicsWeightNue, &drawLine, &right, "E_{reco}#theta_{reco}^{2} (MeV rad^{2})", 1, &currentMaxEffPur, &ubooneMaxEffPur);
