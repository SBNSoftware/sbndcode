void ReconstructionAccuracy()
{
  ...
  std::vector<plt> plots = { {"sp_x_accuracy", "cl_sp_x - cl_truth_x", ";(reco - true) x (cm);Space Points",
                             ...
                             {"sh_pos_accuracy_close", "sh_pos - sh_truth_pos", ";(reco - true) position (cm);Strip Hits",
                              100, -25, 25, plotcolour},
                             {"sh_pos_accuracy_close_no_saturation", "sh_pos - sh_truth_pos", ";(reco - true) position (cm);Strip Hits",
                              100, -25, 25, plotcolour, {}, "!(sh_saturated1 || sh_saturated2)"},
                             {"sh_time_accuracy", "sh_ts1 - (sh_truth_time + 1.7e6)", ";(reco - (true - G4RefTime)) time (ns);Strip Hits",
                              100, -50, 50, plotcolour},
                             {"tr_start_accuracy", "sqrt((tr_start_x - tr_truth_start_x)^2+(tr_start_y - tr_truth_start_y)^2+(tr_start_z - tr_truth_start_z)^2)",
			      ";(reco - true) Start (cm);Tracks", 55, -5, 50, plotcolour},
                             {"tr_start_accuracy_two_sp", "sqrt((tr_start_x - tr_truth_start_x)^2+(tr_start_y - tr_truth_start_y)^2+(tr_start_z - tr_truth_start_z)^2)",
			      ";(reco - true) Start (cm);Tracks", 55, -5, 50, plotcolour, {}, "!tr_triple"},
                             {"tr_start_accuracy_three_sp", "sqrt((tr_start_x - tr_truth_start_x)^2+(tr_start_y - tr_truth_start_y)^2+(tr_start_z - tr_truth_start_z)^2)",
			      ";(reco - true) Start (cm);Tracks", 55, -5, 50, plotcolour, {}, "tr_triple"},
                             ...
                             {"tr_start_z_accuracy", "tr_start_z - tr_truth_start_z", ";(reco - true) Start z (cm);Tracks",
                              100, -50, 50, plotcolour},
                             {"tr_end_accuracy", "sqrt((tr_end_x - tr_truth_end_x)^2+(tr_end_y - tr_truth_end_y)^2+(tr_end_z - tr_truth_end_z)^2)",
			      ";(reco - true) End (cm);Tracks", 55, -5, 50, plotcolour},
                             {"tr_end_accuracy_two_sp", "sqrt((tr_end_x - tr_truth_end_x)^2+(tr_end_y - tr_truth_end_y)^2+(tr_end_z - tr_truth_end_z)^2)",
			      ";(reco - true) End (cm);Tracks", 55, -5, 50, plotcolour, {}, "!tr_triple"},
                             {"tr_end_accuracy_three_sp", "sqrt((tr_end_x - tr_truth_end_x)^2+(tr_end_y - tr_truth_end_y)^2+(tr_end_z - tr_truth_end_z)^2)",
			      ";(reco - true) End (cm);Tracks", 55, -5, 50, plotcolour, {}, "tr_triple"},
