...
{
  const TString saveDir = "/sbnd/data/users/hlay/crt/clustering/plots/v09_67_00/matchingperformance";
  ...
  tree->Add("/sbnd/data/users/hlay/crt/clustering/crtana_v09_67_00_alternative_matchableness.root");
  ...
  TH1F *hSPMatchableLength = new TH1F("hSPMatchableLength", ";Track length (cm);TPC Tracks", 100, 0, 100);
  TH1F *hSPMatchableMatchedLength = new TH1F("hSPMatchableMatchedLength", ";Track length (cm);TPC Tracks", 100, 0, 100);
  TH1F *hTRMatchableLength = new TH1F("hTRMatchableLength", ";Track length (cm);TPC Tracks", 100, 0, 100);
  TH1F *hTRMatchableMatchedLength = new TH1F("hTRMatchableMatchedLength", ";Track length (cm);TPC Tracks", 100, 0, 100);
  TH1F *hSPMatchedLength = new TH1F("hSPMatchedLength", ";Track length (cm);TPC Tracks", 100, 0, 100);
  TH1F *hSPWellMatchedLength = new TH1F("hSPWellMatchedLength", ";Track length (cm);TPC Tracks", 100, 0, 100);
  TH1F *hTRMatchedLength = new TH1F("hTRMatchedLength", ";Track length (cm);TPC Tracks", 100, 0, 100);
  TH1F *hTRWellMatchedLength = new TH1F("hTRWellMatchedLength", ";Track length (cm);TPC Tracks", 100, 0, 100);
