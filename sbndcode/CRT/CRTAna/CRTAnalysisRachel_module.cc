////////////////////////////////////////////////////////////////////////
// Class:       CRTAnalysisRachel
// Plugin Type: analyzer
// File:        CRTAnalysisRachel_module.cc
...
class sbnd::crt::CRTAnalysisRachel : public art::EDAnalyzer {
public:
  explicit CRTAnalysisRachel(fhicl::ParameterSet const& p);
  // The compiler-generated destructor is fine for non-base
  // classes without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  CRTAnalysisRachel(CRTAnalysisRachel const&) = delete;
  CRTAnalysisRachel(CRTAnalysisRachel&&) = delete;
  CRTAnalysisRachel& operator=(CRTAnalysisRachel const&) = delete;
  CRTAnalysisRachel& operator=(CRTAnalysisRachel&&) = delete;
...
sbnd::crt::CRTAnalysisRachel::CRTAnalysisRachel(fhicl::ParameterSet const& p)
  : EDAnalyzer{p}
...
void sbnd::crt::CRTAnalysisRachel::analyze(art::Event const& e)
{
  if(!fFEB){
...
void sbnd::crt::CRTAnalysisRachel::AnalyseMCParticles(std::vector<art::Ptr<simb::MCParticle>> &MCParticleVec)
{
...
void sbnd::crt::CRTAnalysisRachel::AnalyseSimDeposits(std::vector<art::Ptr<sim::AuxDetSimChannel>> &SimDepositVec)
{
...
void sbnd::crt::CRTAnalysisRachel::AnalyseFEBDatas(std::vector<art::Ptr<FEBData>> &FEBDataVec)
{
...
void sbnd::crt::CRTAnalysisRachel::AnalyseCRTStripHits(const art::Event &e, const std::vector<art::Ptr<CRTStripHit>> &CRTStripHitVec)
{
...
void sbnd::crt::CRTAnalysisRachel::AnalyseCRTClusters(const art::Event &e, const std::vector<art::Ptr<CRTCluster>> &CRTClusterVec, const art::FindManyP<CRTSpacePoint> &clustersToSpacePoints)
{
...
void sbnd::crt::CRTAnalysisRachel::AnalyseTrueDepositsPerTagger(const std::map<CRTBackTrackerAlg::Category, bool> &recoStatusMap)
{
...
void sbnd::crt::CRTAnalysisRachel::AnalyseTrueDeposits(const std::map<int, std::pair<bool, bool>> &recoStatusMap)
{
  const unsigned nTrueDeposits = recoStatusMap.size();
...
void sbnd::crt::CRTAnalysisRachel::AnalyseCRTTracks(const art::Event &e, const std::vector<art::Ptr<CRTTrack>> &CRTTrackVec)
{
...
void sbnd::crt::CRTAnalysisRachel::AnalyseTPCMatching(const art::Event &e, const art::Handle<std::vector<recob::Track>> &TPCTrackHandle,
...
DEFINE_ART_MODULE(sbnd::crt::CRTAnalysisRachel)
