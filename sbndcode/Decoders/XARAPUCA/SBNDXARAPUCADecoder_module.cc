...
private:
  ...
  std::vector<art::InputTag> fcaen_fragment_names; /**< Fragments accepted by this decoder. */
  ...
  art::InputTag fframeshift_product_name; /**< Label identifying the module containing the FrameShift module products. */
  ...
  */
  ...
  // Main processing (decoding) method.
...
: EDProducer{p}
{
  ...
  fcaen_fragment_names = p.get<std::vector <art::InputTag> > ("caen_fragment_names", {"CAENV1740", "ContainerCAENV1740"});
  ...
  fframeshift_product_name = p.get<art::InputTag>("frameshift_product_name", "frameshift");
...
void sbndaq::SBNDXARAPUCADecoder::produce(art::Event& e) {
  ...
  for (const art::InputTag &caen_name: fcaen_fragment_names) {
    art::Handle <std::vector <artdaq::Fragment> > fragment_handle;
    e.getByLabel(caen_name, fragment_handle);
...
// ===============  Main fragment processing (decoding) method ===============  //
