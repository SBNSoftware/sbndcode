...
void InputVars()
{
  const TString save_dir = "/sbnd/data/users/hlay/ncpizero/plots/NCPiZeroAv2/crumbs/training/inputvars";
  ...
  std::vector<Plot> plots = { { "tpc_CRFracHitsInLongestTrack", "tpc_CRFracHitsInLongestTrack",
                              ...
                              { "pds_OpT0MeasuredPE", "pds_OpT0MeasuredPE",
                                ...
                                50, -10000, 100000 },
                              { "pds_OpT0HypothesisPE", "pds_OpT0HypothesisPE",
                                ";OpT0HypothesisPE;Slices (normalised)",
                                50, -10000, 100000 },
  };
