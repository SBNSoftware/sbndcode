...
void nuclearFragments::RecoFilter::beginJob()
{
...
float nuclearFragments::RecoFilter::Completeness(std::vector< art::Ptr<recob::Hit>> const &objectHits, int const &trackID)
{
...
float nuclearFragments::RecoFilter::Purity(std::vector<art::Ptr<recob::Hit>> const &objectHits, int const &trackID)
{
  std::map<int,int> objectHitsMap;
  objectHitsMap.clear();
