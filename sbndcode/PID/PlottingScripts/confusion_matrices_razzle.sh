...
root -l -b -q 'ConfusionMatrixRazzle.C(true, false, true, .5, .5)'
root -l -b -q 'ConfusionMatrixRazzle.C(true, false, false, .5, .5)'
root -l -b -q 'ConfusionMatrixRazzle.C(false, true, true, .5, .5)'
root -l -b -q 'ConfusionMatrixRazzle.C(false, true, false, .5, .5)'
