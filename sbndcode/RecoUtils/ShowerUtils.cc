...
std::pair<int,double> ShowerUtils::TrueParticleIDFromTrueChain(const detinfo::DetectorClocksData& clockData,
...
std::map<geo::PlaneID,int> ShowerUtils::NumberofWiresHitByShower(const detinfo::DetectorClocksData& clockData,
...
void ShowerUtils::CutShowerMothersByDensity(const detinfo::DetectorClocksData& clockData,
                                            std::map<int,std::vector<int> >& ShowersMothers,
