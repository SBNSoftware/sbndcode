...
opdet::PosRecoCVNProducer::PosRecoCVNProducer(fhicl::ParameterSet const& p)
  : EDProducer{p},
    ...
    fModelPath( p.get<std::string>("ModelPath", "v0419_trained_w_388k_position/saved_model") ),
    fDirModelPath( p.get<std::string>("DirModelPath", "v0419_trained_w_388k_direction_2d/saved_model") ),
