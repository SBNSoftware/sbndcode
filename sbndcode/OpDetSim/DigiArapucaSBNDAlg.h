...
namespace opdet{
  ...
  class DigiArapucaSBNDAlg{
    ...
    void ConstructWaveform(int ch, sim::SimPhotons const& simphotons, std::vector<std::vector<short unsigned int>>& waveforms, std::string pdName, double start_time, unsigned n_samples);
    void ConstructWaveformLite(int ch, sim::SimPhotonsLite const& litesimphotons, std::vector<std::vector<short unsigned int>>& waveforms, std::string pdName, double start_time, unsigned n_samples);
  ...
  // Declare member data here.
    ...
    double fArapucaEffx; 
    unsigned int fNsamples;   //waveform time interval (ns)
