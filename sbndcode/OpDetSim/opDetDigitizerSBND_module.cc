...
namespace opdet {
  ...
  */
    ...
    , fTriggerAlg(config().trigAlgoConfig())
  {
    ...
    wConfig.Sampling_arara =  config().araAlgoConfig().araraFrequency() / 1000.0; //in GHz
    ...
    wConfig.Nsamples_arara = (wConfig.EnableWindow[1] - wConfig.EnableWindow[0]) * 1000. /*us -> ns*/ * wConfig.Sampling_arara /* GHz */;
